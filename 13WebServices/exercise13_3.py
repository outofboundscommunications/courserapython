...
data, and retrieve the first place_id from the JSON. A place ID is a textual identifier that uniquely identifies 
...
address= parameter that is properly URL encoded using the urllib.urlencode() fuction as shown in 
...
have a place_id of "ChIJJ8oO7_B_bIcR2AlhC8nKlok".
...
Hint: The first seven characters of the place_id are "ChIJO1f ..."

ChIJO1fmBTxUzkYRvcQc8HJOKds
