...
2. then unzip the file and edit where.data to add an address nearby where you live - don't reveal your actual location.
...
5. Then open where.html to visualize the map. Take screen shots as described below.
